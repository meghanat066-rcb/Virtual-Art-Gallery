...
const formattedSelectedPrice =
    ...
    <div className="artevora-artist-name">
        <button
            type="button"
        ...
        <button
            ...
            onClick={handleArtistNavigation}
        >
            Know more about artist <span>→</span>
        </button>
    </div>
    ...
    <strong>
        {artwork.year || 'Year not specified'}
                ...
                <div className="artevora-artwork-visual">
                    <div className="artevora-artwork-visual">
    <div
        className="artevora-main-artwork-image"
        onMouseMove={(e) => {
    ...
    <div className="artevora-size-section">
       ...
       <div className="artevora-size-selector">
    <div className="artevora-size-heading">
        <span>SELECT SIZE</span>
        <span className="artevora-selected-size">
            {selectedSize}
        </span>
    </div>

    <div className="artevora-size-options">
