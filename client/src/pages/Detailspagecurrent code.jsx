...
function ArtworkDetailsNew() {
    ...
    const [selectedSize, setSelectedSize] =
        useState('Medium')
    const [visualizeSize, setVisualizeSize] = useState('Small');
...
setRelatedArtworks(similarArtworks) 
    ...
    const activeSize =
        ...
        const activeVisualizeSize = ARTWORK_SIZES.find(
    (size) => size.name === visualizeSize
) || ARTWORK_SIZES[0]
...
const handleShare = async () => {
    ...
    return (
        <div className="artevora-new-details-page">
            ...
            ========================================== */}
<section
    className={`artevora-product-section ${
        isReplica
            ? 'artevora-product-section-replica'
            : 'artevora-product-section-original'
    }`}
>
    ...
    <div className="artevora-product-visual">
        ...
        <div className="artevora-zoom-container">
            ...
            <img
                ...
                alt={artwork.title}
                style={{
                    '--artwork-size-scale': activeSize.previewScale
                }}
                onMouseEnter={(event) => {
    ...
    <div className="artevora-product-info">
        ...
        <div className="artevora-artwork-type">
        ...
        {isOriginal && (
            ...
            <div className="artevora-original-details">

                {/* STORY */}

                <div className="artevora-original-story">
                ...
                <div className="artevora-original-specifications">
        ...
        {isReplica && (
            ...
            <div className="artevora-replica-details">
                ...
                <div className="artevora-price-section">
                    ...
                    <div>
                        ...
                        <p>
                            Replica price · Inclusive of all taxes
                        </p>
                ...
                <div className="artevora-replica-availability">
        ...
        <div className="artevora-purchase-actions">
            ...
            {isOriginal && artwork.availability === 'Sold' && (
                <button
                    type="button"
                    className="artevora-enquire-button"
                    onClick={handleEnquiry}
...
<section className="artevora-visualize-section">
    ...
    value={visualizeSize}
    onChange={(event) =>
        setVisualizeSize(event.target.value)
    }
...
{artwork?.image && (
    <div
        ...
        style={{
            ...
            width: `calc(${activeRoom.wallWidth} * ${activeVisualizeSize.previewScale})`,
            maxHeight: activeRoom.wallHeight
        }}
    >
        <div
        className="artevora-wall-frame"
        style={{
            aspectRatio: `${activeVisualizeSize.widthRatio} / ${activeVisualizeSize.heightRatio}`
        }}
    >
